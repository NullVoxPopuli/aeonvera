...
ActiveRecord::Schema.define(version: 20170922194347) do
  ...
  create_table "attendances", id: :serial, force: :cascade do |t|
    ...
    t.index ["host_id", "host_type", "attendance_type"], name: "index_attendances_on_host_id_and_host_type_and_attendance_type"
    t.index ["host_id", "host_type"], name: "index_attendances_on_host_id_and_host_type"
  end

  create_table "attendances_discounts", id: :serial, force: :cascade do |t|
  ...
  create_table "competition_responses", id: :serial, force: :cascade do |t|
    t.integer "attendance_id"
  ...
  create_table "discounted_items", id: :serial, force: :cascade do |t|
    t.datetime "created_at"
    t.datetime "updated_at"
  end
