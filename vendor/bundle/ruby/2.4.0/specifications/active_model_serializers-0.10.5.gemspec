# -*- encoding: utf-8 -*-
# stub: active_model_serializers 0.10.5 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_development_dependency(%q<grape>.freeze, ["< 1.0", ">= 0.13"])
      ...
      s.add_dependency(%q<jsonapi-renderer>.freeze, ["< 0.2", ">= 0.1.1.beta1"])
      ...
      s.add_dependency(%q<grape>.freeze, ["< 1.0", ">= 0.13"])
